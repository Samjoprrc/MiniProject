...
public class Normalmode extends JPanel{
    private final ImageIcon hard = new ImageIcon(this.getClass().getResource("/Image/normalmode.png"));
    ...
    ArrayList<Mons2> monster = new ArrayList<>();
        ...
        public void run() {
            while(true){
                try{
                    ...
                    if(letgo == true){
                        monster.add(new Mons2("Monster1"));
                    }
            }
        }
    });
        ...
        public void run() {
            while(true){
                try{
                    ...
                    if(letgo == true){
                        monster.add(new Mons2("Monster2"));
                    }
            }
        }
    });
        ...
        public void run() {
            while(true){
                try{
                    ...
                    if(letgo == true){
                        monster.add(new Mons2("Monster3"));
                    }
            }
        }
    });
        ...
        public void run() {
            while(true){
                try{
                    ...
                    if(letgo == true){
                        monster.add(new Mons2("Monster4"));
                    }
            }
        }
    });
