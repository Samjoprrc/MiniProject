...
public class Hardmode extends JPanel{
    private final ImageIcon normal = new ImageIcon(this.getClass().getResource("/Image/hardmode.png"));
    ...
    public void paintComponent(Graphics g){
        if(crash == 1){
            ...
            this.remove(Bhome);
            int i;
            g.drawImage(normal.getImage(),0,0,1280,690,this);            
            ...
            g.drawString("SCORE : "+times, 400, 300);
